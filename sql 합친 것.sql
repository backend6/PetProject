...
-- 11 새로 추가 --
create table price(
    ino NUMBER(8) NOT NULL CONSTRAINT p_ino_fk REFERENCES INTRODUCE(ino), -- 소개글 번호
...
-- 이거 오류나면  mypet 들어가서 제약조건 이름 확인 하고 바꿔서 해보기
...
insert into price values(2,'김펫',30000,50000,40000,70000,50000,90000);
